...
The data from food.com has divided into two seprated datasets: food_recipe and user_interactions. For the food_recipe dataset, some relevant columns to our projects are *recipe name*, *recipe id*, and*number of ingredients* For the user_interactions dataset, some relevant columns to our projects are *recipe id* and*rating*